<section class="bg-background2-color">
  <div class="container py-20 mx-auto">
    <h2 class="mb-12 text-center text-head-color font-bold text-4xl">Featured videos</h2>

    <div id="vedioSlider" class="splide" dir="ltr">
      <div class="splide__track">
        <ul class="splide__list">
          <li class="splide__slide">
            <div class="flex flex-wrap -m-12">
              <div class="p-12 md:w-1/2 flex flex-col items-center justify-center">
                {{-- <img alt="ecommerce" class="object-cover object-center" src="https://dummyimage.com/400x400"> transform -translate-x-1/2 -translate-y-1/2 --}}
                <div class="relative">
                  <a href="">
                    <img class="object-cover object-center rounded-tl-full rounded-br-full"
                      src="{{ asset('images/vedios/v3.jpg') }}" alt="blog">
                    <img
                      class="play-icon absolute h-16 object-cover w-16 z-10 animate__animated animate__pulse animate__infinite animate__slow"
                      src="{{ asset('images/icons/play.png') }}" alt="paly">
                  </a>
                </div>
              </div>
              <div class="p-12 md:w-1/2 flex flex-col items-start justify-center">
